...
class AriaDownloadHelper(DownloadHelper):
    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if STOP_DUPLICATE_MIRROR:
          ...
          if smsg:
              dl.getListener().onDownloadError(f'File is already available in drive. You should have search before mirror any file.\n\n')
    ...
    def __onDownloadPause(self, api, gid):
        ...
        dl = getDownloadByGid(gid)
        dl.getListener().onDownloadError('❌ stopped by user or admin')
